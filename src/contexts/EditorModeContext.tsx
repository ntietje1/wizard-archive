...
import { EditorModeActionsContext, EditorModeStateContext } from '~/hooks/useEditorMode'
...
export function EditorModeProvider({
  ...
  const stateValue = useMemo(() => ({
    ...
    viewAsPlayerId: isDm ? viewAsPlayerId : campaignWithMembership.data?.member._id,
  ...
  const setViewAsPlayerId = useCallback((playerId: Id<'campaignMembers'> | undefined) => {
