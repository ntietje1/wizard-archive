...
describe('RenderExternalEmbedBlock', () => {
  ...
  it('serializes sidebar item embed props for BlockNote paste parsing', () => {
    const props = {
      block: {
        props: {
          previewWidth: 360,
          sidebarItemId: 'note_1',
    ...
    expect(section).toHaveAttribute(NOTE_EMBED_EXTERNAL_HTML_ATTRIBUTE, 'true')
    expect(section).toHaveAttribute('data-target-kind', 'sidebarItem')
    expect(section).toHaveAttribute('data-sidebar-item-id', 'note_1')
