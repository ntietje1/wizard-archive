...
describe('editor workspace source boundaries', () => {
  it('keeps live current-item and editor-mode reads inside the live workspace source', () => {
    ...
    expect(liveSource).toContain('useCreateFileSystemItem')
    expect(liveSource).not.toContain('useSidebarWorkspaceSource')
    expect(liveSource).not.toContain('createSidebarItem')
    ...
    expect(sourceContract).not.toContain('creationDraft')
    ...
    expect(liveSource).not.toContain('useSidebarUIStore')
    expect(liveSource).not.toContain('pendingItemName')
    ...
    expect(topbar).not.toContain('creationDraft')
    expect(topbar).not.toContain('pendingItemName')
