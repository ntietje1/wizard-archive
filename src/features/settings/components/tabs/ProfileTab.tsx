...
} from '~/features/settings/components/SettingsSubDialog'
import {
  Avatar,
  AvatarFallback,
  AvatarImage,
...
function UsernameRow({ profile }: { profile: Profile }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // If the user is on a campaign page that uses their old username in the
      // URL, navigate to the same page with the new username.
