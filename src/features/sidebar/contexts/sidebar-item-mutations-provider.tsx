...
} from '~/features/sidebar/hooks/useSidebarItemMutations'
...
import { SidebarItemMutationsContext } from '~/features/sidebar/hooks/useSidebarItemMutations'
...
export function SidebarItemMutationsProvider({
  ...
  const permanentlyDeleteItem = (item: AnySidebarItem) => {
  ...
  const value: SidebarItemMutationsValue = {
    createItem,
    getDefaultName,
    rename,
    moveItem,
