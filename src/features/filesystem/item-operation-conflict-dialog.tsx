    ...
    <table className="w-full border-collapse" aria-label="Conflict choices">
      ...
      <tbody className="divide-y">
        {conflicts.map((itemConflict) => {
          ...
          const SourceIcon = DEFAULT_SIDEBAR_ITEM_ICONS[itemConflict.sourceType] ?? FileText
          const DestinationIcon =
            DEFAULT_SIDEBAR_ITEM_ICONS[itemConflict.destinationType] ?? FileText
          return (
            <tr key={itemConflict.sourceItemId}>
