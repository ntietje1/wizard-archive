    ...
    <section className="py-24">
      <LandingContainer>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-12">
          ...
          <BentoCard
            icon={MapPinned}
            title="Reveal the world as the party discovers it."
            body="Upload any map, pin locations to campaign content, and decide which players can see which discoveries before the next reveal lands."
            visualLabel="Interactive campaign map with mixed visibility pins, linked locations, and discovery markers"
