...
vi.mock('../useCanvasSelectionRect', () => ({
...
vi.mock('../useCanvasPointerBridge', () => ({
...
vi.mock('../useCanvasDropIntegration', () => ({
...
vi.mock('../useCanvasNodeDragHandlers', () => ({
...
vi.mock('../useCanvasCursorPresence', () => ({
