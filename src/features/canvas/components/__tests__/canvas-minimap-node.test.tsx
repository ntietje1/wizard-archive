...
import * as canvasNodeRenderers from '../../nodes/canvas-node-renderers'
...
describe('MiniMapNode', () => {
  ...
  it('renders a custom minimap node when the registry provides one', () => {
    vi.spyOn(canvasNodeRenderers, 'renderCanvasNodeMinimap').mockReturnValue(
  ...
  it('falls back to the default rectangle when the registry has no custom minimap renderer', () => {
    vi.spyOn(canvasNodeRenderers, 'renderCanvasNodeMinimap').mockReturnValue(null)
