...
export function EmbedEmptyState({
  ...
  return (
    <div
      ...
      className="flex h-full min-h-36 w-full flex-col items-center justify-center gap-3 rounded-md border border-dashed border-border bg-muted/30 p-4 text-center"
    >
