import { DragHandleButton, SideMenu, type SideMenuProps } from '@blocknote/react'
...
export const SideMenuRenderer = (props: SideMenuProps<CustomBlockSchema, CustomInlineContentSchema, CustomStyleSchema>) => (
  <SideMenu {...props}>
