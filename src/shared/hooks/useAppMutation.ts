...
type UseAppMutationOptions<TMutation extends MutationRef, TContext = unknown> = Omit<
  UseMutationOptions<TData<TMutation>, Error, TArgs<TMutation>, TContext>,
  'mutationFn'
>

export function useAppMutation<TMutation extends MutationRef, TContext = unknown>(
  mutation: TMutation,
