...
type CanvasToolSpecsById = {
  [TId in CanvasToolId]: Extract<AnyCanvasToolSpec, { id: TId }>
}
...
export const canvasToolSpecs = {
  ...
  text: textToolSpec,
  edge: edgeToolSpec,
} as const satisfies CanvasToolSpecsById

const orderedCanvasToolSpecs = Object.values(canvasToolSpecs)
