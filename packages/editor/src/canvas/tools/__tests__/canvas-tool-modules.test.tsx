...
import { createMockCanvasToolRuntime } from './helpers/create-mock-canvas-tool-runtime'
...
function createToolRuntime(): CanvasToolRuntime {
  const runtime = createMockCanvasToolRuntime({ activeTool: 'select' })
...
describe('canvas tool specs', () => {
  ...
  it('exports awareness and local overlay layers and keeps awareness clear behavior on specs', () => {
