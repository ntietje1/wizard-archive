...
export type CanvasEmbedNodeTarget = Extract<CanvasContextMenuTarget, { kind: 'embed-node' }>
...
export interface CanvasContextMenuCreateItemSourceContext {
  canEdit: boolean
...
export interface CanvasContextMenuSource {
  createItems?: (
