...
export function createRectangleSelectionStrategy({
  ...
  localOverlay: Pick<CanvasToolLocalOverlayControls, 'setSelectSelectionDragRect'>
  ...
  return {
    ...
    createInitialState: (input) => ({
      currentClientPoint: copyPoint(input.clientPoint),
      square: input.square,
      startClientPoint: copyPoint(input.clientPoint),
    }),
    ...
    preview: (state) => {
      ...
      localOverlay.setSelectSelectionDragRect(canvasRect)
    ...
    clear: () => {
      localOverlay.setSelectSelectionDragRect(null)
...
export function createLassoSelectionStrategy({
  ...
  getAwareness: () => CanvasAwarenessPresenceWriter
  localOverlay: Pick<CanvasToolLocalOverlayControls, 'setLassoPoints'>
