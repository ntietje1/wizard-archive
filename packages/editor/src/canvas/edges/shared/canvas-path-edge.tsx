...
export function CanvasPathEdge({
  ...
  const { remoteEdgeHighlights } = useCanvasCollaborationRuntime()
  ...
  const remoteHighlight = interactiveRenderMode ? remoteEdgeHighlights.get(props.id) : undefined
  const hasSelectedHighlight =
    interactiveRenderMode && (visuallySelected || Boolean(remoteHighlight))
  ...
  return (
    <CanvasPathEdgeVisual
      ...
      highlightColor={remoteHighlight?.color}
      pathRef={pathRef}
...
function CanvasPathEdgeVisual({
  ...
  const selectedHighlightStyle = showSelectedHighlight
    ? {
        ...
        stroke: highlightColor ?? SELECTED_EDGE_HIGHLIGHT_STYLE.stroke,
  ...
  return (
    <g
      ...
      data-edge-remote-selected={highlightColor ? 'true' : 'false'}
    >
      <path
        ref={pathRef}
        id={id}
      ...
      {selectedHighlightStyle ? (
        <path
          ...
          data-canvas-highlight-stroke-width={selectedHighlightStrokeWidth}
