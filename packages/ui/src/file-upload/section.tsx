...
function FileUploadInput({
  ...
  return (
    <input
      ...
      disabled={disabled}
      aria-label={hasVisibleLabel ? undefined : 'Upload file'}
    ...
    >
      ...
      {fileUpload.preview && (
        <button
          ...
          onClick={(e) => {
            e.stopPropagation()
            window.open(fileUpload.preview, '_blank', 'noopener,noreferrer')
          }}
...
export function FileUploadSection({
  ...
  return (
    <div className="space-y-2">
      {label && (
        <Label htmlFor={inputId} className="text-sm font-semibold pt-2">
          {label}
        </Label>
      )}
